...
The commit-message should be written in English and should not contain any special characters like umlauts, single-quotes, double-quotes, backslashes or non-ascii-characters.
